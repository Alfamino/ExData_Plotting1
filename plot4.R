...
with(dd  , {
  plot( dt , Global_active_power ,type="l" ,xlab="",xaxt = "n",ylab="Global active Power (kilowatts) ", col="gray")
...
with(dd  , {
  plot( dt , Voltage ,type="l" ,xlab="datetime",xaxt = "n",ylab="Voltage", col="black")
  custom.xticks <- c(dd$dt[0], dd$dt[1] ,dd$dt[length( dd$dt)/2] ,dd$dt[length( dd$dt)])
  axis(1, at = custom.xticks, labels = c("Thu", "Fri", "Sat"), las = 1)
})
...
with(dd  , {
  plot( dt , Sub_metering_1 ,type="l" ,xlab="",xaxt = "n",ylab="Energy sub metering", col="black")
  points( dt , Sub_metering_2 ,type="l" ,xlab="",xaxt = "n",ylab="Energy sub metering", col="red")
  points( dt , Sub_metering_3 ,type="l" ,xlab="",xaxt = "n",ylab="Energy sub metering", col="blue")
  custom.xticks <- c(dd$dt[0], dd$dt[1] ,dd$dt[length( dd$dt)/2] ,dd$dt[length( dd$dt)])
  axis(1, at = custom.xticks, labels = c("Thu", "Fri", "Sat"), las = 1)
...
with(dd  , {
  plot( dt , Global_reactive_power ,type="l" ,xlab="datetime",xaxt = "n",ylab="Voltage", col="black")
  custom.xticks <- c(dd$dt[0], dd$dt[1] ,dd$dt[length( dd$dt)/2] ,dd$dt[length( dd$dt)])
  axis(1, at = custom.xticks, labels = c("Thu", "Fri", "Sat"), las = 1)
})
